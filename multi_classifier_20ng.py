...
op.add_option('--all_categories', action='store_true',
              dest='all_categories',
              help='Whether to use all categories or not.')
op.add_option('--use_hashing', action='store_true',
              help='Use a hashing vectorizer.')
op.add_option('--n_features', action='store', type=int, default=2
              ** 16,
...
duration = time() - t0
print('done in %fs at %0.3fMB/s' % (duration, data_train_size_mb
      / duration))
...
duration = time() - t0
print('done in %fs at %0.3fMB/s' % (duration, data_test_size_mb
      / duration))
...
results = []
for (clf, name) in ((RidgeClassifier(tol=0.01, solver='lsqr'),
                    'Ridge Classifier'), (Perceptron(n_iter=50),
                    'Perceptron'),
